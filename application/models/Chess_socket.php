<?php
class Chess_socket extends CI_Model{
    const LOG_PATH = './';
    ...
    private function doServer() {
		...
		//array_column返回sockets数组中键值为'resource'的列
        ...
        foreach ($sockets as $socket) {
            ...
            if ($socket == $this->master) {
                ...
                // 创建,绑定,监听后accept函数将会接受socket要来的连接,一旦有一个连接成功,将会返回一个新的socket资源用以交互,
